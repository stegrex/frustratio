...
class BroadcastsResponse():
    ...
    def __init__(self, broadcastsDataStore=None, messagesDataStore=None):
    ...
    def get_all_messages(self):
        return self.messagesDataStore.get_all_messages()
    ...
    def process_broadcast(self, messageID, broadcaster):
        ...
        self.broadcastsDataStore.create(broadcast)
    ...
    def get_last_broadcasts(self, n):
        return self.broadcastsDataStore.get_last(n)